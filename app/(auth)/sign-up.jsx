            ...
            >
                <SafeAreaView className="h-full">
                    ...
                    <ScrollView >
                        ...
                        <Animatable.View animation='slideInUp' className="bg-white min-h-[85vh] w-full px-4 my-6" style={{ borderRadius: 40 }}>
                            <View className="justify-start items-center pt-10">
                                <Text className='text-cyan-500 font-pextrabold text-2xl'>Welcome to our app</Text>
