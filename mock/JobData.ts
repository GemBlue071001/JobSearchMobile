...
export const companyData: Company[] = [
    {
      ...
      overview: {
        title: "2024 Vietnam Best IT Companies! Delivering top-performing marketplace platforms in Switzerland.",
      ...
      jobOpeningsCount: 4,
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD7rW11p8msxbUW6vgqwP643kpg57TTeIBkA&s",
      jobs: [
        {
          id: 1,
    ...
    },
    {
      ...
      location: "Ho Chi Minh",
      jobOpeningsCount: 4,
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbE0yag0tnwO45YygCMwN23N0zH7ijiYRC1A&s",
      jobs: [
        {
          id: 1,
          title: "Senior / Expert AWS Cloud Engineer (Platform Team)",
    ...
    // Continue adding other companies similarly...
  ];
