    ...
    <div class="card">
      ...
      <div class="header">
        ...
        <div class="profile-details">
          <div class="user-name">Phuong</div>
      ...
      <div class="education-details">
        ...
        ${UserProfileData?.educationDetails
          .map(
            (edu) => `
          <div>
            <p><strong>School Name:</strong> ${edu.name || "Not provided"}</p>
      ...
      <div class="skill">
        ...
        <ul>
          ${UserProfileData?.skillSets
            .map(
              (skills) =>
                `<li>${skills.name}: ${skills.description.replace(
                  /<\/?[^>]+(>|$)/g,
                  ""
                )}</li>`
            )
        ...
        ${UserProfileData?.experienceDetails
          .map(
            ...
            <div>
              ...
              <p>Responsibilities: ${exp.responsibilities.replace(
                /<\/?[^>]+(>|$)/g,
                ""
              )}</p>
              <p>Achievements: ${exp.achievements.replace(
                /<\/?[^>]+(>|$)/g,
                ""
              )}</p>
            </div>`
