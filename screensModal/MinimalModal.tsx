            ...
            <div class="section">
              ...
              ${
                UserProfileData?.educationDetails
                  .map(
                    (edu) => `
                  <div class="school-name">School name: ${edu.name || "N/A"}</div>
                  <div>Major: ${edu.fieldOfStudy || "N/A"}</div>
                  <div>From: ${edu.startDate || "N/A"} - To: ${
                      edu.endDate || "Present"
                    }</div>
          ...
          <View style={styles.leftColumn}>
              ...
              {UserProfileData?.educationDetails.map((edu, index) => (
                <View key={index}>
                  <Text style={styles.schoolName}>
                    School name: {edu.name || 'N/A'}
                  </Text>
                  <Text>Major: {edu.fieldOfStudy || 'N/A'}</Text>
                  <Text>
                    From: {edu.startDate} - To: {edu.endDate || 'Present'}
                  </Text>
            ...
            <View style={styles.section}>
              ...
              {UserProfileData?.skillSets.map((skill, index) => (
                <Text key={index}>• {skill.name || 'N/A'}</Text>
              ))}
            </View>
          </View>
            ...
            <View style={styles.section}>
              ...
              {UserProfileData?.experienceDetails.map((exp, index) => (
                <View key={index}>
                  ...
                  <Text>Responsibilities: {exp.responsibilities || 'N/A'}</Text>
                  <Text>Achievements: {exp.achievements || 'N/A'}</Text>
                </View>
              ))}
            </View>
          </View>
